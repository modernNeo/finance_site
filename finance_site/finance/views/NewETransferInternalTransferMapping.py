...
from finance.models.GroupingModels import ETransferToInternalTransferMapping
...
class NewETransferInternalTransferMapping(View):
    ...
    def get(self, request):
        ...
        refunds = FinalizedTransaction.objects.all().filter(payment_method__in=["Debit Card"], price__gt=0).order_by('-date')
        return render(
    ...
    def post(self, request):
        ...
        e_transfer_to_internal_transfer_mapping.e_transfer = FinalizedTransaction.objects.get(id=post_dict['etransfer'])
