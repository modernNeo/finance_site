...
urlpatterns = [
    ...
    path('update/transaction/<int:transaction_id>', UpdateTransaction.as_view(), name="update_transaction"),
    path('update/item/<int:item_id>', UpdateItem.as_view(), name="update_item"),
