...
from finance_site.models.TransactionModels import TransactionCategory, TransactionLabelIntersection, Transaction, \
                        ...
                        if len(matching_uncategorized_bank_csv_transactions) == 0:
                            ...
                            if "paypal *cineplex" in name.lower() and len(categories) != 1:
                                ...
                                for original_transaction in original_transactions:
                                    if len(original_transaction.get_reimbursement_transactions_set.all()) == 0:
