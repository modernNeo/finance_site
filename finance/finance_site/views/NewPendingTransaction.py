...
from finance_site.models.TransactionModels import PendingTransaction, TransactionCategory, TransactionBase, Transaction
from finance_site.urls import update_pending_transaction
    ...
    def get(self, request):
        return render(
            ...
            context={
                ...
                "who_will_pay_choices": [who_will_pay_choice[0] for who_will_pay_choice in Transaction.who_will_pay_choices],
