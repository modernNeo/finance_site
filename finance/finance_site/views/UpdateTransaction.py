...
from finance_site.models.TransactionModels import Transaction, TransactionBase, TransactionCategory
...
class UpdateTransaction(View):
    def get(self, request, transaction_id):
        ...
        transactions_reimbursing_this_transaction = transaction.get_transactions_that_are_reimbursing_this_transaction()
        transactions_this_transaction_reimburses = transaction.get_receipts_that_this_transaction_is_a_reimbursement_for()
