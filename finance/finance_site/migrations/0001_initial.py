# Generated by Django 4.1.3 on 2022-12-05 01:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Item',
            fields=[
                ('itembase_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='finance_site.itembase')),
            ],
            bases=('finance_site.itembase',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('transactionbase_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='finance_site.transactionbase')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='finance_site.transactioncategory')),
            ],
            bases=('finance_site.transactionbase',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('itembase_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='finance_site.itembase')),
                ('pending_transaction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='finance_site.pendingtransaction')),
            ],
            bases=('finance_site.itembase',),
        ),
        migrations.CreateModel(
